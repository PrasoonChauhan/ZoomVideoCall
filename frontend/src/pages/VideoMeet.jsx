...
export default function VideoMeetComponent() {
  ...
  const getPermissions = async () => {
    try {
      const videoPermissions = await window.navigator.mediaDevices.getUserMedia(
        { video: true }
      );
      if (videoPermissions) {
      ...
      const audioPermissions = await window.navigator.mediaDevices.getUserMedia(
        { audio: true }
      );
      if (audioPermissions) {
          ...
          <>
            <div className={styles.meetVideoContainer}>
              ...
              {videos.map((video) => {
                ...
                return (<div className={styles.conferenceView} key={video.socketId}>
